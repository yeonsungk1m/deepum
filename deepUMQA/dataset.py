...
class DecoyDataset(Dataset):
    def __init__(self,
                 targets,
                 root_dir        = "/data7/yeonsungkim/deepum_graph/data/train/features",
                 multi_dir       = False,
                 root_dirs       = ["/data7/yeonsungkim/deepum_graph/data/train/features", "/data7/yeonsungkim/deepum_graph/data/train/features"],
                 lengthmax       = 300, 
